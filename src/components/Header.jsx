        ...
        <div className="flex flex-col md:flex-row md:justify-between items-center my-8 space-y-4">
            ...
            <div className="flex flex-row justify-between items-center gap-4">
                ...
                <div className="flex justify-between items-center relative">
                    <input className="py-4 px-4 bg-gray-100 rounded-full placeholder-gray-800 outline-none" type="text" placeholder="Seatch" />
                    <div className="absolute inset-y-0 -left-1 pl-4 flex  items-center ml-40 text-2xl">
