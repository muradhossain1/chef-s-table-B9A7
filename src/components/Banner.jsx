    ...
    return (
        <div className="bg-cover bg-no-repeat rounded-3xl md:w-full h-full md:h-[35.5rem] mb-10" style={{backgroundImage : 'url(https://i.ibb.co.com/3kYtv41/banner.png)'}}>
            <div className="w-9/12 mx-auto flex flex-col justify-center items-center text-center h-full space-y-6 py-4">
                ...
                <p className="tetx-lg text-white font-normal">Whether you are a beginner or a seasoned chef, our expert-led sessions offer personalized guidence and inspiration. Join us for an enriching culinary experience thet is sure to ignite your passion for food and cooking </p>
